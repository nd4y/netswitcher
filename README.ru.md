...
[<img src="https://raw.githubusercontent.com/ImranR98/Obtainium/main/assets/graphics/badge_obtainium.png" alt="Установить через Obtainium" height="54">](https://apps.obtainium.imranr.dev/redirect.html?r=obtainium://add/https://github.com/nd4y/netswitcher)
...
всегда ставит последний релиз, а дальше подхватывает обновления сама. (GitHub вырезает
ссылки со схемой `obtainium://` из отрендеренного README, поэтому кнопка на самом деле
ведёт на редирект-страницу самого Obtainium, которая мгновенно передаёт управление
приложению.) Если кнопка не сработала, в Obtainium можно добавить приложение вручную,
вставив адрес репозитория: `https://github.com/nd4y/netswitcher`.
...
Пять поверхностей, все настраиваются на вкладке «Кнопки»:
